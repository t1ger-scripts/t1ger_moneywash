--- Indexed by [id] rather than a positional array so a location's identity never depends
--- on its position in this list - safe to insert/remove/reorder entries without breaking
--- any player-owned business records already stored in the database (type + id lookup).
---
--- Each location entry supports an optional `price` field to override that specific
--- location's purchase price. If omitted, the tier's base price (Config.Business.Tiers)
--- is used. Useful for rural/less desirable spots (e.g. Paleto Bay, Sandy Shores) that
--- you may want priced lower than their big-city counterparts of the same business type.
---
--- Ordered below to match the business tier ladder (Config.Business.Tiers), lowest to highest.
...
return {
    ...
    gas_station = {
        ...
        [3] = {coords = vector4(181.859344, 6637.028809, 31.621948, 175.748032), brand = "RON", price = 4000}, -- example: Paleto Bay, priced lower
        ...
        [6] = {coords = vector4(-2546.123047, 2315.854980, 33.205811, 5.669291), brand = "RON", price = 4000}, -- example: rural
        ...
        [10] = {coords = vector4(47.538464, 2788.127441, 57.874023, 147.401581), brand = "Xero Gas", price = 4000}, -- example: Sandy Shores
        [11] = {coords = vector4(-530.769226, -1221.547241, 18.445435, 337.322845), brand = "Xero Gas"},
        [12] = {coords = vector4(-92.162636, 6411.046387, 31.638794, 36.850395), brand = "Xero Gas", price = 4000}, -- example: Paleto Bay
        [13] = {coords = vector4(2673.138428, 3265.410889, 55.228516, 246.614166), brand = "Xero Gas", price = 4000}, -- example: Grand Senora Desert
        [14] = {coords = vector4(1699.450562, 6425.485840, 32.750977, 150.236221), brand = "Globe Oil", price = 4000}, -- example: rural north
        ...
        [17] = {coords = vector4(1778.109863, 3325.780273, 41.428589, 300.472443), brand = "Globe Oil", price = 4000}, -- example: Sandy Shores
        [18] = {coords = vector4(265.846161, 2598.224121, 44.832275, 8.503937), brand = "Globe Oil", price = 4000}, -- example: Grand Senora Desert
        [19] = {coords = vector4(1039.371460, 2664.184570, 39.541382, 0.000000), brand = "Globe Oil", price = 4000}, -- example: Sandy Shores
        ...
        [24] = {coords = vector4(1694.795654, 4924.035156, 42.220459, 53.858269), brand = "LTD Gasoline", price = 4000}, -- example: Grapeseed
    },
    ...
    restaurant = {
        ...
        [18] = {coords = vector4(1588.971436, 6449.907715, 25.303345, 153.070862), brand = "Up-n-Atom Burger", price = 4000}, -- example: Paleto Bay
    ...
    laundromat = {
        ...
        [8] = {coords = vector4(-52.219780, 6458.874512, 31.487183, 48.188972), brand = "No Marks Cleaners", price = 5000}, -- example: Paleto Bay
        [9] = {coords = vector4(-3053.973633, 635.986816, 7.391968, 291.968506), brand = "No Marks Cleaners", price = 5000}, -- example: Alamo Sea, rural
    },
    ...
    bar = {
        ...
        [4] = {coords = vector4(1986.276978, 3055.529785, 47.208008, 221.102371), brand = "Yellow Jack Inn", price = 6000}, -- example: Sandy Shores
        [5] = {coords = vector4(-262.153839, 6291.428711, 31.487183, 226.771667), brand = "The Bay Bar", price = 6000}, -- example: Paleto Bay
        [6] = {coords = vector4(-131.248352, 6378.632812, 32.177979, 127.559052), brand = "Mojito Inn", price = 6000}, -- example: Paleto Bay
    ...
    stripclub = {
        ...
        [4] = {coords = vector4(-301.767029, 6254.637207, 31.504028, 229.606293), brand = "The Hen House", price = 8000}, -- example: Paleto Bay
    },
